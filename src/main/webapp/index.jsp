...
<body class="animsition">
	...
	<header>
		<%--link header----%>
		<jsp:include page="linkheader.jsp"></jsp:include>
		<%--	footer--%>
	</header>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(cozastore-master/images/slide-01.jpg);">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="cozastore-master/images/banner-01.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="cozastore-master/images/banner-02.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="cozastore-master/images/banner-03.jpg" alt="IMG-BANNER">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						...
						<div class="block2-pic hov-img0">
							...
							<a href="/giohang?id=${sp.id}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								giỏ hàng
							</a>
						</div>
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-01.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="cozastore-master/images/product-detail-01.jpg">
									...
									<div class="item-slick3" data-thumb="images/product-02.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="cozastore-master/images/product-detail-02.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="images/product-03.jpg.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="cozastore-master/images/product-03.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="cozastore-master/images/product-detail-03.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
